...
def generate_ai_tip(category, user_context=""):
    ...
    prompt = (
        f"You are a financial assistant. You use Philippine Peso. In exactly 2 sentences, give a direct, actionable money-saving tip for someone who spends a lot of money on {category}. "
